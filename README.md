...
|--------|---------|-------------|
| 1 | firmware_local | Reads DHT11 & prints temperature/humidity |
| 2 | firmware_mqtt_hivemq | Sends JSON data to HiveMQ Cloud |
| 3 | firmware_freertos | FreeRTOS tasks: sensor + publisher |
